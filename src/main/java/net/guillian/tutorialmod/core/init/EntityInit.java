...
import net.guillian.tutorialmod.common.entity.*;
...
public final class EntityInit {
    ...
    public static  final RegistryObject<EntityType<ArrowTracking>> ARROW_TRACKING = ENTITIES.register("arrow_tracking",()-> EntityType.Builder.<ArrowTracking>of(ArrowTracking::new,MobCategory.MISC).sized(0.5f,0.5f).clientTrackingRange(4).updateInterval(20).build(new ResourceLocation(Tutorialmod.MOD_ID,"arrow_tracking").toString()));
